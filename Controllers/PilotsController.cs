...
namespace AirPortAssignment.Controllers
{
    public class PilotsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,AirplanTypeCanFly")] Pilot pilot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,AirplanTypeCanFly")] Pilot pilot)
        {
            if (ModelState.IsValid)
            {
